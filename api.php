...
switch($types)   // 根据请求的 Api，执行相应操作
{
    ...
    default:
        echo '<!doctype html><html><head><meta charset="utf-8"><title>信息</title><style>* {font-family: microsoft yahei}</style></head><body> <h2>DLOnlinePlayer</h2><h3>http://duangduang.cf</h3><br>';
